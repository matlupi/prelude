(custom-set-variables
 ...
 ;;'(TeX-engine (quote latex))
 ;;'(TeX-engine (quote luatex)) ;; for beamer presentation with different fonts
 '(custom-safe-themes
   (quote
 ...
 '(safe-local-variable-values (quote ((TeX-command-extra-options . "-enable-write18"))))
 '(show-paren-mode t)
